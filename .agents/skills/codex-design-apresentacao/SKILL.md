---
name: codex-design-apresentacao
description: "Selecionar e aplicar os prompts migrados de codex-design-apresentacao quando o usuário pedir um fluxo coberto por esta coleção. Não usar como substituto de uma skill mais específica já disponível."
---
...
- `prompt-completo.md` — Guia completo — Apresentação executiva de desempenho no Codex Design
